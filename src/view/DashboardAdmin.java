...
public class DashboardAdmin extends JFrame {
    ...
    private void initComponents() {
        ...
        // ✅ LOAD DULU → BARU BUAT PANEL (INI KUNCINYA!)
        loadStatistics(); // ← 🔥 DIPINDAH KE ATAS!
        JPanel statsPanel = createStatsPanel(); // ← sekarang pakai data terbaru
    ...
    private JPanel createCardPanel() {
        ...
        Object[][] menuItems = {
            ...
            {"Kelola User", "👥", PRIMARY, (ActionListener) e -> openManageUser()},
            ...
            {"Laporan", "📊", new Color(108, 99, 255), (ActionListener) e -> openLaporan()}
        };
    ...
    private String getDescription(String title) {
        switch (title) {
            ...
            case "Laporan": return "Lihat laporan transaksi";
            default: return "";
        }
    }
